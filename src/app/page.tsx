        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card p-8 md:p-12 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100">
            <div className="flex flex-col items-center text-center">
              ...
              {/* Content */}
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                Kode Terbuka, Transparan, dan Dapat Dikustomisasi
              </h3>
              <p className="text-gray-600 leading-relaxed mb-8 max-w-2xl">
                UPer.li dibangun dengan prinsip keterbukaan. Source code tersedia untuk dipelajari,
                diaudit, dan dikontribusikan oleh komunitas. Kami percaya pada transparansi dalam
                pengembangan software untuk menciptakan solusi yang lebih baik.
              </p>

              {/* CTA Button */}
              <a
                href="https://uper.li/source"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-gray-900 rounded-xl hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
              >
